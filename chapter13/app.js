...
function Employee(id, name, department, salary) {
  ...
  const Emp1 = new Employee(1, "Fatima", "HR", 40000);
  const Emp2 = new Employee(2, "Kinza", "Marketing", 70000);
  const Emp3 = new Employee(3, "Rida", "IT", 80000);
...
function Employee(id, name, department, salary) {
  ...
  // Create multiple records
  const emp1 = new Employee(1, "Fatima", "HR", 50000);
  const emp2 = new Employee(2, "Kinza", "Marketing", 60000);
  const emp3 = new Employee(3, "Rida", "IT", 70000);
